...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,KC_RBRC,        KC_BSLS,     KC_DEL, LT(1,KC_APP), KC_PGDN,    KC_P7,  KC_P8,  KC_P9,  KC_PPLS,
    ...
    KC_LCTL,KC_RCTL,KC_LALT,KC_MHEN,                KC_SPC,                 KC_HENK,KC_KANA,KC_RALT,KC_RGUI,KC_END,KC_LGUI,KC_LEFT,KC_DOWN,KC_RGHT,            KC_P0,  KC_PDOT,KC_PEQL
    ),
    LAYOUT(
